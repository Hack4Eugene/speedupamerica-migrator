class EnableStates < ActiveRecord::Migration
  # Enable counties, tracts, and blocks in Oregon, Washington, Idaho
  execute "UPDATE boundaries SET enabled = true WHERE boundary_type IN ('county', 'census_tract', 'census_block') AND boundary_id REGEXP '^(41|53|16)'"
  # Washington ZIPs
